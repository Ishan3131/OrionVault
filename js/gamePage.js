...
const platform_icons = {
    ...
    nintendoswitch: `<svg data-hercules-id="src/pages/game/page.tsx:95:4" data-hercules-name="svg" viewBox="0 0 24 24" class="w-5 h-5" fill="currentColor"><path data-hercules-id="src/pages/game/page.tsx:96:6" data-hercules-name="path" d="M9.1 2.4C5.4 2.4 2.4 5.4 2.4 9.1v5.8c0 3.7 3 6.7 6.7 6.7h2.7V2.4H9.1zm.6 10.5c-.9 0-1.7-.8-1.7-1.7s.8-1.7 1.7-1.7 1.7.8 1.7 1.7-.8 1.7-1.7 1.7zM14.9 2.4v19.2h.2c3.7 0 6.7-3 6.7-6.7V9.1c0-3.7-3-6.7-6.7-6.7h-.2zm2 10.5c-.9 0-1.7-.8-1.7-1.7s.8-1.7 1.7-1.7 1.7.8 1.7 1.7-.8 1.7-1.7 1.7z"></path></svg>`,
