        ...
        try {
            ...
            .then(res => {
                if('external_id' in res){ 
                    document.querySelector('game-page-video-about').innerHTML += `
                    <div class="game-page-video">
                        <iframe src="https://www.youtube.com/embed/${videoId.external_id}" frameborder="0" allowfullscreen></iframe>
                    </div>`
                }
            })
